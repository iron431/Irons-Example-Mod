...
import static io.redspace.ironsspellbooks.api.spells.SpellRegistry.SPELL_REGISTRY_KEY;

public class SpellRegistry {
    public static final DeferredRegister<AbstractSpell> SPELLS = DeferredRegister.create(SPELL_REGISTRY_KEY, IronsExampleMod.MODID);
